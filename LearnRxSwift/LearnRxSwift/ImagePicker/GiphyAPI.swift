...
extension Giphy: TargetType {
    ...
    public var baseURL: URL { return URL(string: "http://imstlife.com.cn/RunManage/run")! }
    ...
    public var task: Task {
        ...
        case let .upload(data):
            return .upload(.multipart([MultipartFormData(provider: .data(data), name: "file", fileName: "gif.jpg", mimeType: "image/jpeg")]))
        }
    }
